...
int main()
{
	...
	while(true){	
	if(_dnsauth.Run())
		cout << "_dnsauth Update address success." << endl;
	else cout << "_dnsauth Update address fail." << endl;

	if(www.Run())
		cout << "www Update address success." << endl;
	else cout << "www Update address fail." << endl;
